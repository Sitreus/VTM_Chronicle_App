    ...
    <div style={{ ...S.card, position: "relative", cursor: "pointer" }}
      ...
      <div style={{ display: "flex", gap: 16 }}>
        ...
        <div style={{ flex: 1 }}>
          ...
          {ch.concept && <div style={{ color: accent, fontSize: 38, marginTop: 2 }}>{ch.concept}</div>}
      ...
      {ch.backstory && (
        <div style={{ marginTop: 12 }}>
          <div style={{ fontSize: 38, lineHeight: 1.7, color: "#d4c8ae", whiteSpace: "pre-wrap" }}>
          ...
          {hasLongBackstory && (
            <button onClick={toggleExpand} style={{
              ...
              fontFamily: "'Cinzel', serif", fontSize: 28, letterSpacing: 1,
      ...
      {plainLines.length > 0 && (
        <div style={{ marginTop: 8, fontSize: 36, fontStyle: "italic", color: "#b0a490", whiteSpace: "pre-wrap" }}>
          {plainLines.join("\n")}
        </div>
      )}
              ...
              <div key={i} style={{ marginBottom: 10 }}>
                ...
                {isList ? (
                  <ul style={{ margin: 0, paddingLeft: 20, listStyleType: "none" }}>
                    {items.map((item, j) => (
                      <li key={j} style={{ fontSize: 34, lineHeight: 1.6, color: "#c4b899" }}>
                  ...
                  <div style={{ fontSize: 34, lineHeight: 1.6, color: "#c4b899", paddingLeft: 4 }}>
                    {value}
                  </div>
                )}
              </div>
