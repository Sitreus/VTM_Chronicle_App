    ...
    <div style={{ ...S.card, position: "relative", cursor: "pointer" }}
      ...
      {ch.backstory && (
        <div style={{ marginTop: 12 }}>
          <div style={{ fontSize: 19, lineHeight: 1.7, color: "#d4c8ae", whiteSpace: "pre-wrap" }}>
      ...
      {plainLines.length > 0 && (
        <div style={{ marginTop: 8, fontSize: 18, fontStyle: "italic", color: "#b0a490", whiteSpace: "pre-wrap" }}>
          {plainLines.join("\n")}
        </div>
      )}
              ...
              <div key={i} style={{ marginBottom: 10 }}>
                ...
                {isList ? (
                  <ul style={{ margin: 0, paddingLeft: 20, listStyleType: "none" }}>
                    {items.map((item, j) => (
                      <li key={j} style={{ fontSize: 17, lineHeight: 1.6, color: "#c4b899" }}>
                  ...
                  <div style={{ fontSize: 17, lineHeight: 1.6, color: "#c4b899", paddingLeft: 4 }}>
                    {value}
                  </div>
                )}
              </div>
